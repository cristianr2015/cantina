...
async function buildTicketPdf(tickets, settings = {}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    tickets.forEach((ticket, index) => {
      ...
      doc.fillColor('#6B7280').font('Helvetica-Bold').fontSize(7).text('VALOR', 42, 198);
      doc.fillColor('#111827').fontSize(14).text(formatMoney(ticket.price_paid), 42, 210);
...
module.exports = { buildTicketPdf, formatMoney };
