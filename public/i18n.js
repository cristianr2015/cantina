(function () {
  ...
  const messages = {
    ...
    'Activá todas las herramientas de administración, control y análisis de la aplicación.': { pt: 'Ative todas as ferramentas de administração, controle e análise do aplicativo.', en: 'Enable every administration, control, and analytics tool in the application.' },
    ...
    'Cada clave puede utilizarse una sola vez y vence un año después de su activación.': { pt: 'Cada chave pode ser usada apenas uma vez e expira um ano após a ativação.', en: 'Each key can be used only once and expires one year after activation.' },
    ...
    'Los cambios se aplican a ventas nuevas y las cortesías siempre valen $0.': { pt: 'As alterações se aplicam a novas vendas e as cortesias sempre valem $0.', en: 'Changes apply to new sales and courtesy tickets are always $0.' },
    'Entrada anticipada $': { pt: 'Ingresso antecipado $', en: 'Advance ticket $' },
    'Entrada en puerta $': { pt: 'Ingresso na entrada $', en: 'Door ticket $' },
